...
public class FormKhachHang extends FormMenu {
    ...
    private String generateCustomerId() {
        String prefix = currentCustomerId.substring(0, 3);
        int number = Integer.parseInt(currentCustomerId.substring(3)) + 1;
        ...
        currentCustomerId = String.format("%s%03d", prefix, number); // Tạo mã khách hàng mới
